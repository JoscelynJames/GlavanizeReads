  ...
  return knex('book').del()
    .then(function() {
      ...
      return knex('book').insert([{
        ...
        cover_img: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/python_in_a_nutshell.jpg'
      }, {
        id: 2,
        title: 'Think Python',
        genre: 'Python',
        ...
        cover_img: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/think_python.jpg'
      }, {
        id: 3,
        ...
        cover_img: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/learning_react_native.jpg'
      }, {
        id: 4,
        ...
        cover_img: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/es6_and_beyond.jpg'
      }, {
        id: 5,
        ...
        cover_img: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/scope_and_closures.jpg'
      }, {
        id: 6,
        ...
        cover_img: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/async_and_performance.jpg'
      }, ]);
    }).then(function() {
